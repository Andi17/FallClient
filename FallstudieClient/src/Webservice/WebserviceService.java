    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://Webservice/", "WebserviceService");
    ...
    public Webservice getWebservicePort() {
        return super.getPort(new QName("http://Webservice/", "WebservicePort"), Webservice.class);
    }
    ...
    public Webservice getWebservicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Webservice/", "WebservicePort"), Webservice.class, features);
    }
